    ...
    return (
        <div className={classes.root}>
            <Grid container spacing={1}>
                <Grid container item xs={12} sm={12} lg={5} style={{ backgroundColor: '#fff', padding: '1%' }} >
                    ...
                    <Grid item lg={8} xs={6} sm={6}>
                        ...
                        <Grid container item lg={12} xs={12} sm={12}>
                            ...
                            <Grid item lg={2} sm={4} xs={4} className={styles.listItemStock}>
                                <span>Stock</span>
                            </Grid>
                            <Grid item lg={2} sm={4} xs={4} className={styles.listItemPrice}>
                        ...
                        <Grid container item lg={12} xs={12} sm={12} className={styles.itemQty}>
